...
rm(SILVA_128_taxonomy, tax_refinement, over_99, to_refine, SINA_refined)
...
for (i in 1:length(phyloseqs)) {
  ...
  if (i == 1) {
    write.table(otu_table, "D:/VirtualBox/VirtualBox Share/16S/Hazen16S/hazen_all_qcd_no_JI.txt", quote=F, sep="\t", row.names = F)
  } else {
...
# biom convert -i ~/matti/Hazen16S/hazen_all_qcd_no_JI.txt -o ~/matti/Hazen16S/hazen_all_qcd_no_JI.biom --table-type="OTU table" --to-json
# python ~/bin/FAPROTAX_1.0/collapse_table.py -i ~/matti/Hazen16S/hazen_all_qcd_no_JI.biom -o ~/matti/Hazen16S/hazen_func_table_no_JI.biom -g ~/bin/FAPROTAX_1.0/FAPROTAX_Hazen.txt --collapse_by_metadata 'taxonomy' --group_leftovers_as 'other' --out_group_overlaps ~/matti/Hazen16S/hazen_func_table_overlaps_no_JI.txt --output_format_group_overlaps classical  -l ~/matti/Hazen16S/hazen_FAPROTAX_no_JI.log --disable_group_set_operations --out_groups2records_table ~/matti/Hazen16S/hazen_func_table_groups_no_JI.txt -v --force
# biom convert -i ~/matti/Hazen16S/hazen_func_table_no_JI.biom -o ~/matti/Hazen16S/hazen_func_table_no_JI.txt --to-tsv
...
for (i in 1:length(phyloseqs)) {
  ...
  if (i == 1) {
    func <- read.csv("D:/VirtualBox/VirtualBox Share/16S/Hazen16S/hazen_func_table_no_JI.txt",sep="\t",skip=1,row.names=1)
  ...
  if (i == 1) {biom_non_normalized <- biom_non_normalized[,-c(5,6,11:13,19:23)]}
  ...
  svg(filename=paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_rarefaction_no_JI.svg"), width=11.8, height=7.8, pointsize=12)
  ...
  if (i == 1) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_phyla_bars_no_JI.svg"), plot=image, units="mm", width=300, height=200)
  } else {
  ...
  if (i == 1) {
    image <- ggplot(bars_func, aes(x=factor(Sample), y=Abundance, fill=factor(Function))) + scale_x_discrete(limits=sample_levels) + geom_bar(stat="identity") + 
      ...
      xlab("Sample") + ylab("Abundance (%)")
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_bars_no_JI.svg"), plot=image, units="mm", width=300, height=200)
  } else {
  ...
  if (i != 3) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_PCA_biplot_no_JI.svg"), plot=image, units="mm", width=300, height=300)
  }
  ...
  if (i == 1) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_no_JI.svg"), plot=image, units="mm", width=400, height=200)
  } else {
  ...
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_continuous_pd_shannon_no_JI.svg"), plot=image, units="mm", width=400, height=300)
  ...
  if (ncol(Filter(is.factor,pd_richness_2)) > 0) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_categorical_pd_shannon_no_JI.svg"), plot=image, units="mm", width=400, height=300)
  }
  ...
  image <- ggplot(data = pd_continuous_2, aes(value, Inv.Simpson)) + geom_line(size= 1) +
    ...
    theme(strip.text.x = element_text(size = 16), axis.title.y = element_text(size = 16))
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_continuous_pd_no_JI.svg"), plot=image, units="mm", width=400, height=300)
  ...
  if (ncol(Filter(is.factor,pd_richness_2)) > 0) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_categorical_pd_no_JI.svg"), plot=image, units="mm", width=400, height=300)
  }
  ...
  image <- ggplot(data.frame(sum = sample_sums(phyloseqs[[i]])), aes(sum)) + 
    ...
    xlab("Read counts") +
    ylab("Sample count")
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_sequencing_depth_distribution_no_JI.svg"), plot=image, units="mm", width=300, height=300)
  ...
  for (k in 1:nrow(modelstorun_frame)) {
    ...
    if ((length(unique(taxonomy_merged$variable)) >= 20 && !(modelstorun_frame$model[k] %in% continuous_variables)) | 
      ...
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", modelstorun_frame$set[k], "_pd_subplot_",modelstorun_frame$model[k],"no_JI.svg"), plot=pd_ggplots[[k]],
  ...
  if (i == 1) {
    ...
    for (m in 1:length(plots_common)) {
      ...
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_common[m], "no_JI.svg"), plot=image,
    ...
    for (m in 1:length(plots_fun)) {
      image <- ggplot(data = ordisurf_NMDS_data_fun, aes(NMDS1, NMDS2)) + geom_text(aes(label=ordisurf_NMDS_data_fun$Depth.cm, colour=Site), size= 5) +
        ...
        scale_color_manual(values=contours[[m]], name = "Group") + theme(legend.position = "none")
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_fun[m], "no_JI.svg"), plot=image,
             units="mm", width=250, height=200)
    }
    ...
    write.csv(models_out,"D:/VirtualBox/VirtualBox Share/16S/Hazen16S/results_table_no_JI.csv",quote=F)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_ordination_vectors_tax_no_JI.svg"), plot=image,
    ...
    image <- ggplot(data = ordisurf_NMDS_data_fun, aes(x=NMDS1, y=NMDS2)) + geom_point(aes(shape=Lake, colour=Site), size= 5) + coord_fixed() +
      ...
      scale_color_manual(values=contours[[2]], name = "Group") + theme(legend.position = "none")
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_ordination_vectors_fun_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_common_silhouettes_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_common_cluster_pca_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    image <- ggplot(data = sil_fun_hazen_only, aes(x = sample, y = sil_width)) + geom_bar(stat = "identity") + facet_grid(cluster~., scales = "free_y") + coord_flip() + 
      ...
      theme(axis.text.y = element_text(size=12)) 
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_silhouettes_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_cluster_pca_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    image <- ggplot(data = sil_func_otu_only, aes(x = sample, y = sil_width)) + geom_bar(stat = "identity") + facet_grid(cluster~., scales = "free_y") + coord_flip() + 
      ...
      theme(axis.text.y = element_text(size=12))
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_func_otu_silhouettes_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_func_otu_cluster_pca_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_hazen_all_func_otu_cluster_pca_no_JI.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    for (m in 1:length(plots_common)) {
      image <- ggplot(data = ordisurf_NMDS_data_common, aes(NMDS1, NMDS2)) + geom_text(aes(label=ordisurf_NMDS_data_common$Depth.cm, colour=Site), size= 5) +
        ...
        geom_contour(data = eval(parse(text=plots_common[m])), aes(x = x, y = y, z = z, colour=category, alpha=..level..),bins = 20, size=1) +
        scale_color_manual(values=contours[[m]], name = "Group") + theme(legend.position = "none")
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_common[m], "_no_JI.svg"), plot=image,
             units="mm", width=250, height=200)
    }
    ...
    for (m in 1:length(plots_common)) {
      image <- ggplot(data = ordisurf_NMDS_data_fun, aes(NMDS1, NMDS2)) + geom_text(aes(label=ordisurf_NMDS_data_fun$Depth.cm, colour=Site), size= 5) +
        ...
        geom_contour(data = eval(parse(text=plots_fun[m])), aes(x = x, y = y, z = z, colour=category, alpha=..level..),bins = 20, size=1) +
        scale_color_manual(values=contours[[m]], name = "Group") + theme(legend.position = "none")
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_fun[m], "_no_JI.svg"), plot=image,
             units="mm", width=250, height=200)
    }
    ...
    write.csv(models_out,paste0("D:/VirtualBox/VirtualBox Share/16S/hazensummer/", dataset_names[i], "_results_table_no_JI.csv"),quote=F)
  ...
  rm(comp_classify, comp_models)
  gc()
}

#write out the richness and diversity model data, and mantel test summaries
richness_list <- do.call("rbind", richness_list)
write.csv(richness_list,"D:/VirtualBox/VirtualBox Share/16S/richness_list_no_JI.csv",quote=F)
diversity_list <- do.call("rbind", diversity_list)
write.csv(diversity_list,"D:/VirtualBox/VirtualBox Share/16S/diversity_list_no_JI.csv",quote=F)
mantel_list <- do.call("rbind", mantels)
write.csv(mantel_list,"D:/VirtualBox/VirtualBox Share/16S/mantel_list_no_JI.csv",quote=F)
...
for (i in 1:length(phyloseqs)) {
  ...
  write.csv(result_frame, paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_relative_abundances_no_JI.csv"),quote=F)
  write.csv(result_frame_prot, paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_relative_abundances_prot_no_JI.csv"),quote=F)
  #metadata
  write.csv(sample_data(phyloseqs[[i]]), paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_metadata_no_JI.csv"),quote=F)
}

#which taxa were assigned to the functional group of sulfur_respiration?

assoc <- read.csv("D:/VirtualBox/VirtualBox Share/16S/hazen_OTU_func_association_no_JI.csv", sep = "\t")
...
assoc2 <- read.csv("D:/VirtualBox/VirtualBox Share/16S/hazensummer_a_OTU_func_association_no_JI.csv", sep = "\t")

...
for (i in 1:length(phyloseqs)) {
  ...
  if (i == 1) {
    bad_columns <- c("X.SampleID", "BarcodeSequence", "LinkerPrimerSequence", "BarcodeName", "ReversePrimer", "Redox.mV")
  } else {
  ...
  if (i != 3) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_PCA_biplot_no_Redox.svg"), plot=image, units="mm", width=300, height=300)
  }
  ...
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_continuous_pd_shannon_no_Redox.svg"), plot=image, units="mm", width=400, height=300)
  ...
  if (ncol(Filter(is.factor,pd_richness_2)) > 0) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_categorical_pd_shannon_no_Redox.svg"), plot=image, units="mm", width=400, height=300)
  }
  ...
  image <- ggplot(data = pd_continuous_2, aes(value, Inv.Simpson)) + geom_line(size= 1) +
    ...
    theme(strip.text.x = element_text(size = 16), axis.title.y = element_text(size = 16))
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_continuous_pd_no_Redox.svg"), plot=image, units="mm", width=400, height=300)
  ...
  if (ncol(Filter(is.factor,pd_richness_2)) > 0) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_categorical_pd_no_Redox.svg"), plot=image, units="mm", width=400, height=300)
  }
  ...
  for (k in 1:nrow(modelstorun_frame)) {
    ...
    if ((length(unique(taxonomy_merged$variable)) >= 20 && !(modelstorun_frame$model[k] %in% continuous_variables)) | 
      ...
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", modelstorun_frame$set[k], "_pd_subplot_",modelstorun_frame$model[k],"_no_Redox.svg"), plot=pd_ggplots[[k]],
  ...
  if (i == 1) {
    ...
    ordi_common_O2 <- ordisurfs[[7]] #fetch the ordisurf object
    ...
    plots_common <- c("ordi_a_na_common_H2S", "ordi_a_na_common_Sdepth", "ordi_a_na_common_Wdepth", 
                      "ordi_a_na_common_pH", "ordi_a_na_common_O2",  "ordi_a_na_common_Nseq")
    ...
    for (m in 1:length(plots_common)) {
      ...
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_common[m], "_no_Redox.svg"), plot=image,
    ...
    #ordisurf:
    ordi_fun_H2S <- ordisurfs[[11]] #fetch the ordisurf object
    ...
    ordi_fun_Wdepth <- ordisurfs[[15]] #fetch the ordisurf object
    ...
    ordi_fun_pH <- ordisurfs[[16]] #fetch the ordisurf object
    ...
    ordi_fun_O2 <- ordisurfs[[17]] #fetch the ordisurf object
    ...
    ordi_fun_Nseq <- ordisurfs[[19]] #fetch the ordisurf object
    ...
    for (m in 1:length(plots_fun)) {
      image <- ggplot(data = ordisurf_NMDS_data_fun, aes(NMDS1, NMDS2)) + geom_text(aes(label=ordisurf_NMDS_data_fun$Depth.cm, colour=Site), size= 5) +
        ...
        scale_color_manual(values=contours[[m]], name = "Group") + theme(legend.position = "none")
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_fun[m], "_no_Redox.svg"), plot=image,
             units="mm", width=250, height=200)
    }
    ...
    write.csv(models_out,"D:/VirtualBox/VirtualBox Share/16S/Hazen16S/results_table_no_Redox.csv",quote=F)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_ordination_vectors_tax_no_Redox.svg"), plot=image,
    ...
    image <- ggplot(data = ordisurf_NMDS_data_fun, aes(x=NMDS1, y=NMDS2)) + geom_point(aes(shape=Lake, colour=Site), size= 5) + coord_fixed() +
      ...
      scale_color_manual(values=contours[[2]], name = "Group") + theme(legend.position = "none")
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_ordination_vectors_fun_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_common_silhouettes_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_common_cluster_pca_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    image <- ggplot(data = sil_fun_hazen_only, aes(x = sample, y = sil_width)) + geom_bar(stat = "identity") + facet_grid(cluster~., scales = "free_y") + coord_flip() + 
      ...
      theme(axis.text.y = element_text(size=12)) 
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_silhouettes_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_cluster_pca_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    image <- ggplot(data = sil_func_otu_only, aes(x = sample, y = sil_width)) + geom_bar(stat = "identity") + facet_grid(cluster~., scales = "free_y") + coord_flip() + 
      ...
      theme(axis.text.y = element_text(size=12))
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_func_otu_silhouettes_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_func_otu_cluster_pca_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_hazen_all_func_otu_cluster_pca_no_Redox.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    for (l in 1:2) {
      ...
      if (l == 1) {
        ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/func_clustering2_pd_no_Redox.svg"), plot=pd_ggplot,
               units="mm", width=1200, height=200)
      } else  {
        ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/tax_clustering_pd_no_Redox.svg"), plot=pd_ggplot,
               units="mm", width=600, height=200)
      }
    }
...
write.csv(richness_list,"D:/VirtualBox/VirtualBox Share/16S/richness_list_no_Redox.csv",quote=F)
diversity_list <- do.call("rbind", diversity_list)
write.csv(diversity_list,"D:/VirtualBox/VirtualBox Share/16S/diversity_list_no_Redox.csv",quote=F)
mantel_list <- do.call("rbind", mantels)
write.csv(mantel_list,"D:/VirtualBox/VirtualBox Share/16S/mantel_list_no_Redox.csv",quote=F)
...
for (i in 1:length(phyloseqs)) {
  ...
  write.csv(result_frame, paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_relative_abundances_no_Redox.csv"),quote=F)
  write.csv(result_frame_prot, paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_relative_abundances_prot_no_Redox.csv"),quote=F)
  #metadata
  write.csv(sample_data(phyloseqs[[i]]), paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_metadata_no_Redox.csv"),quote=F)
}

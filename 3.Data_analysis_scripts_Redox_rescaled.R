...
for (i in 1:length(phyloseqs)) {
  ...
  if (i == 1) {
    ...
    #rescale redox
    Redox_values <- sample_data_replacement[,c(6,8,12)]
    Redox_values <- ddply(Redox_values, .(Year, Site), transform, mean = mean(Redox.mV))
    Redox_values <- ddply(Redox_values, .(Year, Site), transform, sd = sd(Redox.mV))
    sample_data_replacement$Redox.mV <- (Redox_values$Redox.mV - Redox_values$mean) # / Redox_values$sd
  } 
  ...
  if (i != 3) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_PCA_biplot_Redox_rescaled.svg"), plot=image, units="mm", width=300, height=300)
  }
  ...
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_continuous_pd_shannon_Redox_rescaled.svg"), plot=image, units="mm", width=400, height=300)
  ...
  if (ncol(Filter(is.factor,pd_richness_2)) > 0) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_categorical_pd_shannon_Redox_rescaled.svg"), plot=image, units="mm", width=400, height=300)
  }
  ...
  image <- ggplot(data = pd_continuous_2, aes(value, Inv.Simpson)) + geom_line(size= 1) +
    ...
    theme(strip.text.x = element_text(size = 16), axis.title.y = element_text(size = 16))
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_continuous_pd_Redox_rescaled.svg"), plot=image, units="mm", width=400, height=300)
  ...
  if (ncol(Filter(is.factor,pd_richness_2)) > 0) {
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_richness_categorical_pd_Redox_rescaled.svg"), plot=image, units="mm", width=400, height=300)
  }
  ...
  image <- ggplot(data.frame(sum = sample_sums(phyloseqs[[i]])), aes(sum)) + 
    ...
    xlab("Read counts") +
    ylab("Sample count")
  ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_sequencing_depth_distribution_Redox_rescaled.svg"), plot=image, units="mm", width=300, height=300)
  ...
  for (k in 1:nrow(modelstorun_frame)) {
    ...
    if ((length(unique(taxonomy_merged$variable)) >= 20 && !(modelstorun_frame$model[k] %in% continuous_variables)) | 
      ...
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", modelstorun_frame$set[k], "_pd_subplot_",modelstorun_frame$model[k],"_Redox_rescaled.svg"), plot=pd_ggplots[[k]],
  ...
  if (i == 1) {
    ...
    for (m in 1:length(plots_common)) {
      ...
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_common[m], "_Redox_rescaled.svg"), plot=image,
    ...
    for (m in 1:length(plots_fun)) {
      image <- ggplot(data = ordisurf_NMDS_data_fun, aes(NMDS1, NMDS2)) + geom_text(aes(label=ordisurf_NMDS_data_fun$Depth.cm, colour=Site), size= 5) +
        ...
        scale_color_manual(values=contours[[m]], name = "Group") + theme(legend.position = "none")
      ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_", plots_fun[m], "_Redox_rescaled.svg"), plot=image,
             units="mm", width=250, height=200)
    }
    ...
    write.csv(models_out,"D:/VirtualBox/VirtualBox Share/16S/Hazen16S/results_table_Redox_rescaled.csv",quote=F)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_ordination_vectors_tax_Redox_rescaled.svg"), plot=image,
    ...
    image <- ggplot(data = ordisurf_NMDS_data_fun, aes(x=NMDS1, y=NMDS2)) + geom_point(aes(shape=Lake, colour=Site), size= 5) + coord_fixed() +
      ...
      scale_color_manual(values=contours[[2]], name = "Group") + theme(legend.position = "none")
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_ordination_vectors_fun_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_common_silhouettes_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_common_cluster_pca_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    image <- ggplot(data = sil_fun_hazen_only, aes(x = sample, y = sil_width)) + geom_bar(stat = "identity") + facet_grid(cluster~., scales = "free_y") + coord_flip() + 
      ...
      theme(axis.text.y = element_text(size=12)) 
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_silhouettes_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_fun_cluster_pca_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    image <- ggplot(data = sil_func_otu_only, aes(x = sample, y = sil_width)) + geom_bar(stat = "identity") + facet_grid(cluster~., scales = "free_y") + coord_flip() + 
      ...
      theme(axis.text.y = element_text(size=12))
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_func_otu_silhouettes_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_func_otu_cluster_pca_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/", dataset_names[i], "_hazen_all_func_otu_cluster_pca_Redox_rescaled.svg"), plot=image,
           units="mm", width=300, height=300)
    ...
    for (l in 1:2) {
      ...
      if (l == 1) {
        ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/func_clustering2_pd_Redox_rescaled.svg"), plot=pd_ggplot,
               units="mm", width=1200, height=200)
      } else  {
        ggsave(file = paste0("D:/VirtualBox/VirtualBox Share/16S/Plots/tax_clustering_pd_Redox_rescaled.svg"), plot=pd_ggplot,
               units="mm", width=600, height=200)
      }
    }
    ...
    write.csv(models_out,paste0("D:/VirtualBox/VirtualBox Share/16S/hazensummer/", dataset_names[i], "_results_table_Redox_rescaled.csv"),quote=F)
...
write.csv(richness_list,"D:/VirtualBox/VirtualBox Share/16S/richness_list_Redox_rescaled.csv",quote=F)
diversity_list <- do.call("rbind", diversity_list)
write.csv(diversity_list,"D:/VirtualBox/VirtualBox Share/16S/diversity_list_Redox_rescaled.csv",quote=F)
mantel_list <- do.call("rbind", mantels)
write.csv(mantel_list,"D:/VirtualBox/VirtualBox Share/16S/mantel_list_Redox_rescaled.csv",quote=F)
...
for (i in 1:length(phyloseqs)) {
  ...
  write.csv(result_frame, paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_relative_abundances_Redox_rescaled.csv"),quote=F)
  write.csv(result_frame_prot, paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_relative_abundances_prot_Redox_rescaled.csv"),quote=F)
  #metadata
  write.csv(sample_data(phyloseqs[[i]]), paste0("D:/VirtualBox/VirtualBox Share/16S/", dataset_names[i],"_metadata_Redox_rescaled.csv"),quote=F)
}
